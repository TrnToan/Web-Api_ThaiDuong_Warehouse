...
namespace ThaiDuongWarehouse.Api.Migrations
{
    ...
    [Migration("20240105131841_IsolatedItemLotTable")]
    partial class IsolatedItemLotTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThaiDuongWarehouse.Domain.AggregateModels.IsolatedItemLotAggregate.IsolatedItemLot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ThaiDuongWarehouse.Domain.AggregateModels.ProductInventoryAggregate.FinishedProductInventory", b =>
                {
                    ...
                    b.HasIndex("PurchaseOrderNumber", "ItemId")
                        .IsUnique();
                    ...
                    b.OwnsMany("ThaiDuongWarehouse.Domain.AggregateModels.FinishedProductIssueAggregate.FinishedProductIssueEntry", "Entries", b1 =>
                        {
                            ...
                            b1.HasIndex("ItemId", "PurchaseOrderNumber", "FinishedProductIssueId")
                                .IsUnique();
                    ...
                    b.OwnsMany("ThaiDuongWarehouse.Domain.AggregateModels.FinishedProductReceiptAggregate.FinishedProductReceiptEntry", "Entries", b1 =>
                        {
                            ...
                            b1.HasIndex("ItemId", "PurchaseOrderNumber", "FinishedProductReceiptId")
                                .IsUnique();
