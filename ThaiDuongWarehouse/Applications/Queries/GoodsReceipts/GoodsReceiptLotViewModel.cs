...
public class GoodsReceiptLotViewModel
{
    ...
    public GoodsReceiptLotViewModel(string goodsReceiptLotId, string? locationId, double quantity, double? sublotSize, 
        string? sublotUnit, string? purchaseOrderNumber, DateTime? productionDate, DateTime? expirationDate, 
